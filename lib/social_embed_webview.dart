...
import 'package:social_embed_webview2/platforms/social_media_generic.dart';
import 'package:social_embed_webview2/utils/common_utils.dart';
...
class SocialEmbed extends StatefulWidget {
  ...
  @override
  State createState() => _SocialEmbedState();
}
...
class _SocialEmbedState extends State<SocialEmbed> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    wbController = WebViewController()
      ..loadFile(htmlToURI(getHtmlBody()))
      ...
      ..setNavigationDelegate(NavigationDelegate(
        ...
        onNavigationRequest: (request) async {
          ...
          if (request.isMainFrame && await canLaunchUrlString(url)) {
            launchUrlString(url);
